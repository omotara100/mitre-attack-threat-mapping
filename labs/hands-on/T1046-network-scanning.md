...
- <a href="https://github.com/omotara100/mitre-attack-threat-mapping/blob/main/screenshots/sysmon-eventid3.png">  `screenshots/sysmon-eventid3.png`</a>  — Sysmon Event ID 3 showing connection attempts.  
